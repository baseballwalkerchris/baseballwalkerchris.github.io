...
<div class="full-width-timeline-background">
  <div class="centered-content">
    ...
    <h3 style="text-align: left; margin-left: 60px;">Hover for more details!</h3> 
  <div class="timeline-item">
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">Model Training</div>
        <div class="skill-box">Testing</div>
        <div class="soft-skill-box">Collaboration</div>
      </div>
    </div>
  ...
  <div class="timeline-item">
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">Networking</div>
        <div class="skill-box">Design</div>
        <div class="skill-box">Git</div>
        <div class="soft-skill-box">Problem-solving</div>
        <div class="soft-skill-box">Attention to Detail</div>
      </div>
    </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-text">
      ...
      <h4 class="timeline-position">Backend Python Programmer</h4>
    </div>
    <div class="timeline-media">
      <video controls>
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="soft-skill-box">Communication</div>
        <div class="soft-skill-box">Adaptability</div>
      </div>
    </div>
  </div>
  ...
  <div class="timeline-item">
    <div class="timeline-text">
      ...
      <h4 class="timeline-position">Backend Typescript Programmer</h4>
    </div>
    <div class="timeline-media">
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">APIs</div>
        <div class="soft-skill-box">Delegation</div>
        <div class="soft-skill-box">Creativity</div>
      </div>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">Market Research</div>
        <div class="soft-skill-box">Conflict Resolution</div>
        <div class="soft-skill-box">Responsibility</div>
        <div class="soft-skill-box">Time Management</div>
        <div class="soft-skill-box">Technical Presentation</div>
      </div>
    </div>
  </div>
    ...
    <div class="timeline-media">
     ...
     <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">Networking</div>
        <div class="skill-box">Docker</div>
        <div class="skill-box">Elastic Cloud Services</div>
        <div class="skill-box">Service Discovery</div>
        <div class="soft-skill-box">Prioritization</div>
        <div class="soft-skill-box">Goal Setting</div>
        <div class="soft-skill-box">Taking Initiative</div>
      </div>
    </div>
  </div>
 ...
 <div class="timeline-item">
    ...
    <div class="popup">
      <div class="skills-container">
        ...
        <div class="skill-box">FactoryLogix</div>
        <div class="skill-box">Active Directory</div>
        <div class="skill-box">GUIs</div>
        <div class="skill-box">Excel</div>
        <div class="soft-skill-box">Cross-team Collaboration</div>
        <div class="soft-skill-box">Handling Ambiguity</div>
        <div class="soft-skill-box">Adaptability</div>
      </div>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="popup">
      <div class="skills-container">
        <div class="skill-box">OCaml</div>
        <div class="skill-box">Python</div>
        <div class="skill-box">Unit Testing</div>
        <div class="skill-box">GUIs</div>
        <div class="skill-box">Git</div>
        <div class="soft-skill-box">Teamwork</div>
        <div class="soft-skill-box">Organization</div>
        <div class="soft-skill-box">Meeting Deadlines</div>
      </div>
    </div>
  </div>
